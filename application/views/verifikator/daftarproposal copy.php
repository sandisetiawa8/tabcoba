                    ...
                    <tr>
                        ...
                        <td style="display: flex;">
                            <?php if($user['status'] == 'Menunggu') { ?>
                                <a class="btn btn-primary" href="<?= base_url('verifikator/setujui/'.$user['id']); ?>" role="button" style="margin-right: 5px;">Setuju</a>
                                <a class="btn btn-danger" href="<?= base_url('verifikator/tolak/'.$user['id']); ?>" role="button" style="margin-right: 5px;">Tolak</a>
                            <?php } ?>
                        </td>
