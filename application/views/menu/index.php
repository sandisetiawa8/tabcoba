                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="" class="badge badge-success" style="width: 60px; height: 25px; padding-top: 6px;">Edit</a>
                                <a href="" class="badge badge-danger" style="width: 60px; height: 25px; padding-top: 6px;">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
