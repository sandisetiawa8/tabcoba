  ...
  <body>
        <div class="container-fluid">
            ...
            <div class="card col-lg-8 col-sm-12" style="padding: 20px;">
                <div class="row">
                    <?= form_open_multipart('admin/proses_ubah_penarikan'); ?>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="jumlah" id="jumlah" autocomplete="off" value=<?= $i['penarikan']; ?>  required onkeypress="return hanyaAngka(event)" />
                        </div>
