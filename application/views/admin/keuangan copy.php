...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-sm-12 title">
            <a href="cetakLaporanKeuangan" class="btn mb-2 ms-1" style="background-color: #9E4784; color: white;">Cetak Laporan Keuangan</a>
        </div>
                ...
                ?>
                    <tr>
                        ...
                        <td style="justify-content: center;">
                            <a class="btn btn-sm" href="#" role="button" style="margin-right: 5px; background-color: #008080; color: white" onclick="cetak('<?= base_url('admin/cetak_rek_koran/'.$data['nis']); ?>')">Cetak Rek Koran</a>
                        </td>   
                    </tr>
                <?php } ?>
               </tbody>
        ...
        <div class="modal-dialog" role="document">
            ...
            <script>
                function cetak(href) {
                    Swal.fire({
                        icon: 'info',
                        title: 'Anda yakin ingin mencetak rekening koran ?',
                        text: '',
                        type: 'warning',
                        showCancelButton: true,
