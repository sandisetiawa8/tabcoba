  ...
  <body>
    ...
    <?php } ?>
        ...
        <div class="col-sm-12 title">
            ...
            <a href=<?= base_url('admin/cetak_setoran/'. $data['nis']) ?> class="btn mb-2 ms-1" style="background-color: #008080; color: white;">Cetak Laporan Setoran</a>
        </div>
        ...
        <table class="table table-hover align-middle" id="example">
                <thead style="text-align: center;">
                    <tr>
                        ...
                        <th class="text-center">Riwayat Setoran</th>
                ...
                ?>
                    <tr>
                        ...
                        <td style="display: flex; justify-content: center;" class="text-center" >
                            <a class="btn btn-sm me-1" href="#" role="button" style="background-color: #9E4784; color: white;" onclick="ubah('<?= base_url('admin/ubahsetoran/'.$data['id']); ?>')">Ubah</a>
                            <a class="btn btn-danger btn-sm" href="#" role="button" onclick="hapus('<?= base_url('admin/hapussetoran/'.$data['id']); ?>')">Hapus</a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title align-self-center"
                                id="exampleModalform1">Tambah Data Setoran</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        <?= form_open_multipart('admin/tambahsetoran'); ?>
                                ...
                                <div class="mb-3">
                                    <label for="setoran" class="form-label">Jumlah Setoran</label>
                                    <input type="text" class="form-control" name="setoran" id="setoran" autocomplete="off"  required onkeypress="return hanyaAngka(event)" />
                                </div>
